...
const ModalOrders: React.FC<ModalOrdersProps> = ({ closeModal }) => {
  ...
  const handleSubmit = async () => {
    const estimated_budget = `${budgetFrom.toString().trim()} - ${budgetTo
      .toString()
      .trim()}`;
        ...
        <div className={styles.formContainer}>
          ...
          <div className={styles.inputRow}>
            <div className={styles.inputGroup}>
              ...
              />
              {errors.order_goal && (
                <p className={styles.errorText}>{errors.order_goal}</p>
              )}
            </div>
          ...
          <div className={styles.budgetDateRow}>
            ...
            <div className={styles.dateGroup}>
              ...
              {formTouched &&
                (errors.start_project_at || errors.project_deadline) && (

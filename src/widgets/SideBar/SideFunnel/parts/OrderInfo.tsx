...
export const OrderInfo: React.FC<OrderInfoProps> = ({
  ...
  return (
    <section className={classes.wrapper}>
      <InfoCard title="Запрос" text={order_goal} />

      <InfoCard title="Продукт или услуга" text={product_or_service} />

      <InfoCard title="Проблемы" text={solving_problems} />

      <InfoCard title="Доп. пожелания" text={extra_wishes} />
    </section>
  );
};
